...
(venv) PS C:\Users\Leonel\Downloads\FastExpressRotas> $env:PYTHONPATH="."
...
| Simulador de trânsito | 🔄 Parcial | Automático (thread) e manual (botão) |
...
| Simulação de entrega de carga | 🔄 Parcial/Em andamento | Encadeamento origem → destino com evento de entrega |
| Geração de grafo real | 🔄 Parcial/Em andamento | Layout responsivo e tema visual de transportadora |
| Botões e Legendas | 🔄 Parcial/Em andamento | Faltando aplicar distância apenas na legenda do dijkstra |
